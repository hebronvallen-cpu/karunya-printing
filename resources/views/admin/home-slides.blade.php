...
<section class="panel">
    <div class="panel-head panel-head--between">
        ...
        <div class="panel-actions">
            <a class="btn btn-primary" href="{{ url('/admin/home-slides-form.php') }}">+ Tambah Baru</a>
        </div>

    <form class="admin-filters" method="get" action="{{ url('/admin/home-slides.php') }}">
        ...
        <a class="btn btn-outline btn-sm" href="{{ url('/admin/home-slides.php') }}">Reset</a>
    </form>
            ...
            <tbody>
                @forelse ($slides as $slide)
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-sm btn-outline" href="{{ url('/admin/home-slides-form.php') }}?edit={{ $slide->id }}">Edit</a>
                            <form class="inline" method="post" action="{{ url('/admin/home-slides.php') }}" onsubmit="return confirm('Yakin hapus slide ini?');">
                                @csrf
