...
<p class="admin-login-copy">Kami telah mengirim kode OTP ke email Anda. Masukkan kode 6 digit untuk melanjutkan.</p>
            ...
            <section class="admin-login-card panel reveal">
                ...
                <form method="POST" class="admin-login-form" action="{{ url('/admin/recovery/verify.php') }}">
                    @csrf
                ...
                <div class="login-footer">
                    ...
                    <div class="admin-login-actions">
                        <form method="POST" action="{{ url('/admin/recovery/request.php') }}" style="display:inline;">
                            @csrf
